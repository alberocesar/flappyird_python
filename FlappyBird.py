...
IMAGEM_FONTE = pygame.transform.scale2x(pygame.image.load(os.path.join("imgs", "bg.png")))
IMAGEM_PASSARO = [
...
class Passaro:
    ...
    def mover(self):
        self.contagem += 1
        # Deslocamento
        deslocamento = 1.5 * (self.contagem ** 2) + self.velocidade * self.contagem
    ...
    def desenhar(self, tela):
        ...
        self.contagem += 1
        if self.contagem < self.ANIMACAO_TEMPO:
            self.imagem = self.IMGS[0]
        elif self.contagem < self.ANIMACAO_TEMPO * 2:
            self.imagem = self.IMGS[1]
        elif self.contagem < self.ANIMACAO_TEMPO * 3:
            self.imagem = self.IMGS[2]
        elif self.contagem < self.ANIMACAO_TEMPO * 4:
            self.imagem = self.IMGS[1]
        elif self.contagem == self.ANIMACAO_TEMPO * 4 + 1:
            self.imagem = self.IMGS[0]
            self.contagem = 0
        ...
        if self.angulo <= -80:
            self.imagem = self.IMGS[1]
            self.contagem = self.ANIMACAO_TEMPO*2
...
class Cano:
   ...
   # Colisao     
    def definir_altura(self):
        ...
        self.pos_base = self.pos_base + self.DISTANCIA
